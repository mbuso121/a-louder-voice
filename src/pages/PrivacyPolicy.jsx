        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <div className="prose max-w-none space-y-8 text-[#0A0A0A]/80 leading-relaxed">
            ...
            <section>
              ...
              <p className="mt-2">Contact: <a href="mailto:tshegolsithebe@gmail.com" className="text-[#C5A059] hover:underline">tshegolsithebe@gmail.com</a></p>
            </section>
            ...
            <section>
              ...
              <p className="mt-3">To exercise any of these rights, email us at <a href="mailto:tshegolsithebe@gmail.com" className="text-[#C5A059] hover:underline">tshegolsithebe@gmail.com</a></p>
            </section>
