        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <div className="space-y-8 text-[#0A0A0A]/80 leading-relaxed">
            ...
            <section>
              ...
              <p>We reserve the right to suspend or terminate accounts that violate these terms, without notice. You may delete your account at any time by contacting us at <a href="mailto:tshegolsithebe@gmail.com" className="text-[#C5A059] hover:underline">tshegolsithebe@gmail.com</a>.</p>
            </section>
            ...
            <section>
              ...
              <p>For questions about these terms: <a href="mailto:tshegolsithebe@gmail.com" className="text-[#C5A059] hover:underline">tshegolsithebe@gmail.com</a></p>
            </section>
